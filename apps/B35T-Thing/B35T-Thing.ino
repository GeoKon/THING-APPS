...
//        return;                             // do nothing if not enabled
//    }
//    // come here if enabled
//    const char *key = "hDvZv76KwaTbEtTK6aGPBow5hVWrXp6hYx5Vu4v9vgU";
//    
//    float value  = owon.getValue();
//    char *pvalue = owon.getValueText();
//    char *units  = owon.getUnits( true );
//    char buf1[60];
//    bool trigger = false;
//    int n;
//    
//    if( my.notfyGT && (value > my.notfyGTValue) )
//    {
//        trigger = true;
//        n = sprintf( buf1, "%s%s (>%.1f%s) %d", pvalue, units, my.notfyGTValue, units, reminder );
//        ASSERT( n<60 );
//    }
//    if( my.notfyLT && (value < my.notfyLTValue) )
//    {
//        trigger = true;
//        n = sprintf( buf1, "%s%s (<%.1f%s) %d", pvalue, units, my.notfyLTValue, units, reminder );
//        ASSERT( n<60 );
//    }
//    if( trigger )
//    {
//        if( count == 0 )
//        {
//            ift.trigger( "B35T_TEXT", key, buf1 );
//            PF("Alarm %s\r\n", buf1 );
//            reminder++;
//        }
...
//    }
//    else
//        count = reminder = 0;  // forces retrigger        
//}
